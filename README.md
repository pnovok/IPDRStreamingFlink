...
IPDR data, Flink Map task reached only 4%. The main limiting factor would be the amount of data generated by IPDR data generator but not the Flink processing capacity.
